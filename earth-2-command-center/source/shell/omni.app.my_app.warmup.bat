...
call "%~dp0kit\kit.exe" "%%~dp0apps/omni.app.my_app.kit" --no-window --/app/extensions/excluded/0='omni.kit.splash' --/app/extensions/excluded/1='omni.kit.window.splash' --/app/settings/persistent=0 --/app/settings/loadUserConfig=0 --/structuredLog/enable=0 --/app/hangDetector/enabled=0 --/crashreporter/skipOldDumpUpload=1 --/app/content/emptyStageOnStart=1 --/rtx/materialDb/syncLoads=1 --/omni.kit.plugin/syncUsdLoads=1 --/rtx/hydra/materialSyncLoads=1 --/app/asyncRendering=0 --/renderer/multiGpu/enabled=0 --/app/quitAfter=10 --/plugins/carb.tasking.plugin/threadCount=%TASKING_THREAD_CNT% %*
