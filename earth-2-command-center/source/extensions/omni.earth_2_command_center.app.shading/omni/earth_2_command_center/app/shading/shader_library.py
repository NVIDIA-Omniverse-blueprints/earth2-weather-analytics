...
class ShaderLibrary:
    def __init__(self, ext_path):
        ...
        self._shaders['lookup_latlong_texture'] = ShaderSpec('lookup_latlong_texture',
                self.get_shader_path('mapping_latlong'), 'lookup_latlong_texture',
                # Inputs
        ...
        self._shaders['lookup_latlong_texture_mono'] = ShaderSpec('lookup_latlong_texture_mono',
                self.get_shader_path('mapping_latlong'), 'lookup_latlong_texture_mono',
                # Inputs
                [ ShaderConnectionSpec('texture', Sdf.ValueTypeNames.Asset) ]
                + create_latlon_texture_base_inputs(),
                [ # Outputs
        ...
        for split_u, split_v in [(4,2), (2,1), (2,2)]:
            for mode in ['', '_mono']:
                self._shaders[f'lookup_latlong_texture_split_{split_u}_{split_v}{mode}'] = ShaderSpec(f'lookup_latlong_texture_split_{split_u}_{split_v}{mode}',
                        self.get_shader_path('mapping_latlong'), f'lookup_latlong_texture_split_{split_u}_{split_v}{mode}',
                        # Inputs
        ...
        self._shaders['lookup_goes_texture'] = ShaderSpec('lookup_goes_texture',
                self.get_shader_path('mapping_goes'), 'lookup_goes_texture',
                # Inputs
                [ ShaderConnectionSpec('texture', Sdf.ValueTypeNames.Asset) ]
        ...
        self._shaders['lookup_goes_texture_mono'] = ShaderSpec('lookup_goes_texture_mono',
                self.get_shader_path('mapping_goes'), 'lookup_goes_texture_mono',
                # Inputs
                [ ShaderConnectionSpec('texture', Sdf.ValueTypeNames.Asset) ]
                + create_goes_texture_common_inputs() + create_goes_texture_base_inputs(),
                [ # Outputs
        ...
        self._shaders['lookup_goes_disk_texture'] = ShaderSpec('lookup_goes_disk_texture',
                self.get_shader_path('mapping_goes'), 'lookup_goes_disk_texture',
                # Inputs
                [ ShaderConnectionSpec('texture', Sdf.ValueTypeNames.Asset) ]
        ...
        self._shaders['lookup_goes_disk_texture_mono'] = ShaderSpec('lookup_goes_disk_texture_mono',
                self.get_shader_path('mapping_goes'), 'lookup_goes_disk_texture_mono',
                # Inputs
                [ ShaderConnectionSpec('texture', Sdf.ValueTypeNames.Asset) ]
                + create_goes_texture_common_inputs(),
                [ # Outputs
        ...
        self._shaders['lookup_diamond_texture'] = ShaderSpec('lookup_diamond_texture',
                self.get_shader_path('mapping_diamond'), 'lookup_diamond_texture',
                [ # Inputs
        ...
        self._shaders['lookup_diamond_texture_mono'] = ShaderSpec('lookup_diamond_texture_mono',
                self.get_shader_path('mapping_diamond'), 'lookup_diamond_texture_mono',
                [ # Inputs
                    ShaderConnectionSpec('diamond_0', Sdf.ValueTypeNames.Asset),
                    ShaderConnectionSpec('diamond_1', Sdf.ValueTypeNames.Asset),
                    ShaderConnectionSpec('diamond_2', Sdf.ValueTypeNames.Asset),
        ...
        # HEALpix Textures
        self._shaders['lookup_hpx_texture'] = ShaderSpec('lookup_hpx_texture',
                self.get_shader_path('mapping_hpx'), 'lookup_hpx_texture',
                [ # Inputs
                    ShaderConnectionSpec('tex0', Sdf.ValueTypeNames.Asset),
                    ShaderConnectionSpec('tex1', Sdf.ValueTypeNames.Asset),
                    ShaderConnectionSpec('tex2', Sdf.ValueTypeNames.Asset),
                    ShaderConnectionSpec('tex3', Sdf.ValueTypeNames.Asset),
                    ShaderConnectionSpec('tex4', Sdf.ValueTypeNames.Asset),
                    ShaderConnectionSpec('tex5', Sdf.ValueTypeNames.Asset),
                    ShaderConnectionSpec('tex6', Sdf.ValueTypeNames.Asset),
                    ShaderConnectionSpec('tex7', Sdf.ValueTypeNames.Asset),
                    ShaderConnectionSpec('tex8', Sdf.ValueTypeNames.Asset),
                    ShaderConnectionSpec('tex9', Sdf.ValueTypeNames.Asset),
                    ShaderConnectionSpec('tex10', Sdf.ValueTypeNames.Asset),
                    ShaderConnectionSpec('tex11', Sdf.ValueTypeNames.Asset),
                    ShaderConnectionSpec('rotate', Sdf.ValueTypeNames.Bool),
                    ShaderConnectionSpec('flip_u', Sdf.ValueTypeNames.Bool),
                    ShaderConnectionSpec('flip_v', Sdf.ValueTypeNames.Bool),
                    ],
                [ # Outputs
        ...
        self._shaders['lookup_hpx_texture_mono'] = ShaderSpec('lookup_hpx_texture_mono',
                self.get_shader_path('mapping_hpx'), 'lookup_hpx_texture_mono',
                [ # Inputs
                    ShaderConnectionSpec('tex0', Sdf.ValueTypeNames.Asset),
                    ShaderConnectionSpec('tex1', Sdf.ValueTypeNames.Asset),
                    ShaderConnectionSpec('tex2', Sdf.ValueTypeNames.Asset),
