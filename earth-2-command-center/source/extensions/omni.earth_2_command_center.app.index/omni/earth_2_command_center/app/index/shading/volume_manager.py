...
class ProjectedVolumeManager:
    ...
    _stage_events_sub: carb.eventdispatcher._eventdispatcher.ObserverGuard | None
    ...
    def __init__(self):
        self._stage_events_subs = []
        self._stage_events_subs.append(
            carb.eventdispatcher.get_eventdispatcher().observe_event(
                        ...
                        observer_name="[ext: omni.earth_2_command_center.app.index.shading] stage_opened",
                        on_event=self._on_stage_opened))
        self._stage_events_subs.append(
            carb.eventdispatcher.get_eventdispatcher().observe_event(
                        event_name=omni.usd.get_context().stage_event_name(omni.usd.StageEventType.CLOSED),
                        observer_name="[ext: omni.earth_2_command_center.app.index.shading] stage_closed",
    ...
    def dispose(self):
        self._timeline_sub = None
        for e in self._stage_events_subs:
            e.reset()
