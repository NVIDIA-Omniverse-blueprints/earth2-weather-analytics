...
class GeoConverter:
    ...
    def latlonalt_to_xyz(self, lat_degrees, lon_degrees, altitude):
        return self.lonlatalt_to_xyz(lon_degrees, lat_degrees, altitude)
    ...
    def xyz_to_latlonalt(self, x, y, z):
        lon, lat, alt = self.xyz_to_lonlatalt(x, y, z)
        return lat, lon, alt
