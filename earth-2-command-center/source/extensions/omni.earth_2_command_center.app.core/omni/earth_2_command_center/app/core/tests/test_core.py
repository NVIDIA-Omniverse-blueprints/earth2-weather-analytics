...
class Test(omni.kit.test.AsyncTestCase):
    ...
    async def test_core_feature_properties_time_coverage(self):
        ...
        start_time = datetime(1990,1,1, tzinfo=utc)
        ...
        start_time2 = datetime(1980,1,1, tzinfo=utc)
        end_time2 = datetime(2020,1,1, tzinfo=utc)
    ...
    async def test_sun_motion(self):
        ...
        winter_solstice = datetime.datetime(2024, 12, 21, 9, 21, tzinfo=utc)
        ...
        spring_equinox = datetime.datetime(2026, 3, 20, 14, 46, tzinfo=utc)
        ...
        summer_solstice = datetime.datetime(2023, 6, 21, 14, 58, tzinfo=utc)
